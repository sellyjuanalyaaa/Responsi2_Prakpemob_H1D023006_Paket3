...
import 'package:responsi2mobilepaket3h1d023006/bloc/login_bloc.dart';
    ...
    try {
      ...
      if (res.code == 200 && res.token != null) {
        ...
        ScaffoldMessenger.of(context)
            .showSnackBar(const SnackBar(content: Text('Login gagal, silahkan coba lagi')));
      }
    } catch (e) {
      setState(() => _loading = false);
      if (!mounted) return;
                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 8),
                              Divider(color: Colors.brown.shade200, thickness: 2),
                              const SizedBox(height: 24),
                              TextFormField(
                              ...
                              TextFormField(
                                ...
                                decoration: _deco('Password', icon: Icons.lock_rounded),
                                obscureText: true,
                                validator: (v) => (v == null || v.isEmpty) ? 'Wajib diisi' : null,
                              ),
